        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-red">
                    <h2>Daftar Kategori Dokumentasi</h2>
                </div>
                <div class="body">
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {{ Form::open(array('url' => route('kategori-dokumentasi.store'), 'method' => 'post')) }}
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" name="name" placeholder="Nama Kategori Dokumentasi" required>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $('.btnDelete').click(function(){
        ...
        swal({
            ...
            $.ajax({    //create an ajax request to display.php
                url: "{{ url('admin/kategori-dokumentasi') }}/"+dataId, 
                type: "post",
                data: {
                    "_method": 'delete',
                    "_token": token,
