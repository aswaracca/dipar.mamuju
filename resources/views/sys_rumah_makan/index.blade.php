    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <a href="{{ route('rumah-makan.create') }}" class="btn bg-primary btn-lg waves-effect">+ Tambah</a><br><br>
                     ...
                     <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            @endphp
                            @forelse($rm as $h)
                           <tr onclick="window.location = '{{ route('rumah-makan.show', ['rumah_makan' => $h['id']]) }}'">
                               <td>{{ $i++ }}</td>
