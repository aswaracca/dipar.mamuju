        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        {{ strtoupper($rm->name) }}
                        <small>{{ $rm['kategori']['name'] }}</small>
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            <a href="{{ route('rumah-makan.edit',['rumah_makan' => $rm->id]) }}" class="btn bg-primary btn-lg waves-effect">Edit</a>
    ...
    $('#btnDelete').click(function(){
        swal({
            ...
            $.ajax({    //create an ajax request to display.php
                url: "{{ url('admin/rumah-makan/'.$rm->id) }}", 
                type: "post",
                data: {
                    "_method": 'delete',
                    "_token": '{{ csrf_token() }}',
