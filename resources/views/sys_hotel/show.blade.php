    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        {{ strtoupper($hotel->name) }}
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            <a href="{{ route('hotel.edit',['hotel' => $hotel->id]) }}" class="btn bg-primary btn-lg waves-effect">Edit</a>
                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="gambar">
                            ...
                            <div class="row">
                                @php
                                    $i = count($hotel->gambar);
                                @endphp
                                @forelse($hotel->gambar as $gambar)
                                <div class="col-md-3">
                                    <div class="thumbnail">
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="tipe" value="hotel">
